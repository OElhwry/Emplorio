...
export function IconLightbulb(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M9 18h6" />
      <path d="M10 22h4" />
      <path d="M12 2a7 7 0 0 0-4 12.7c.8.6 1 1.5 1 2.3v1h6v-1c0-.8.2-1.7 1-2.3A7 7 0 0 0 12 2z" />
    </svg>
  );
}
...
export function IconEyeOff(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a20.2 20.2 0 0 1 5.06-5.94M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a20.23 20.23 0 0 1-3.16 4.19" />
...
export function IconPartyPopper(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M22 2L11 13" />
      <path d="M11 13a5 5 0 0 0 7 7l2-8.5-3.5-3.5L8 11l3 2z" />
    </svg>
  );
}
...
export function IconSpinner({ size = 14, ...rest }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      strokeLinecap="round"
      aria-hidden="true"
      className={`spin ${rest.className ?? ''}`.trim()}
      {...rest}
    >
